...
CENTURION/Aquila Team Lead skills and lean skill bundles for Hermes Agent (kit version 0.8.0).
...
Version 0.8.0 routes clear, bounded GPT-6 work to Luna and work requiring
